...
const Home = (props) => {
  ...
  return (
    <div className="home-container">
      ...
      <Header isAuth={false} style={{ maxWidth: 1400 }} />
      ...
      <div className="home-pricing" id="pricing">
        <div className="home-card">
          ...
          <button className="home-button1 button">
            <span className="home-text049">
              <a href="/#download" className="home-text050">Download Now</a>
              <br></br>
            </span>
          </button>
        </div>
        ...
        <div className="home-card1">
          ...
          <span className="home-text057">
            <span>
              No daily file limit or file size limit, transfer unlimited files to all your devices.
            </span>
            <br></br>
          </span>
          <a href="/signup" className="home-button1 button">
            <span>
        ...
        <div className="home-card1">
          <div className="home-container06">
            <span className="home-text052">Lifetime</span>
            <span className="home-text053">
              <span className="home-text054">$97</span>
              <span className="home-text040" style={{ fontSize: "1.5rem" }}></span>
              <br></br>
            </span>
            <span className="home-text056">One-time</span>
          </div>
          <span className="home-text057">
            <span>
              No daily file limit or file size limit, transfer unlimited files to all your devices.
          ...
          <a href="/signup/appsumo" className="home-button1 button">
            <span>
              <span className="home-text061">Upgrade</span>
              <br></br>
            </span>
      ...
      <div className="home-features1" id="download">
